...
const DATA: AreaDef[] = [
  ...
  },
  {
    ...
    tagline: "Turning code into the interface a person sees and uses.",
    icon: "MonitorPlay",
    topics: [
      ["html-dom", "HTML & the DOM"],
      ["css-layout", "CSS & layout"],
      ["browser-rendering", "How the browser renders"],
      ["dom-events", "JavaScript in the browser"],
      ["components-state", "Components & state"],
      ["reactivity-rerender", "Reactivity & re-rendering"],
      ["client-routing-spa", "Client-side routing & SPAs"],
      ["state-management", "State management"],
      ["accessibility", "Accessibility (a11y)"],
      ["bundling-build", "Bundling & the build step"],
